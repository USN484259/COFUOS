...
rem /EHa 
cl /GS- /Oxi /Zi /DEBUG:FULL /D "_DEBUG" /fp:strict /Zc:wchar_t,auto,rvalueCast /TP /Wall /KERNEL /FAsc /Fasymbol\ /Fobin\ /Febin\COFUOS.sys /Fdbin\COFUOS.pdb COFUOS.cpp global.cpp pe.cpp heap.cpp lock.cpp apic.cpp exception.cpp mm.cpp ps.cpp mp.cpp bits.cpp /link /FIXED /MACHINE:X64 /ENTRY:krnlentry /NODEFAULTLIB /SUBSYSTEM:NATIVE /STACK:0x10000,0x2000 /HEAP:0,0 /BASE:0xFFFF800002000000 bin\hal.obj
@echo --------------------------------------------
@pause > nul
